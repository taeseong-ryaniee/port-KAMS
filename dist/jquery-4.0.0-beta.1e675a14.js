...
},{}],"js/jquery-4.0.0-beta.js":[function(require,module,exports) {
...
(function (global, factory) {
  ...
  jQuery.each(("checked selected async autofocus autoplay controls defer disabled " + "hidden ismap loop multiple open readonly required scoped").split(" "), function (_i, name) {
    jQuery.attrHooks[name] = {
      get: function get(elem) {
        return elem.getAttribute(name) != null ? name.toLowerCase() : null;
      },
  ...
  jQuery.ajaxTransport(function (options) {
    ...
    return {
      send: function send(headers, complete) {
        ...
        xhr.onabort = xhr.onerror = xhr.ontimeout = _callback("error");
  ...
  function canUseScriptTag(s) {
    ...
    return s.scriptAttrs || !s.headers && (s.crossDomain ||
  ...
  jQuery.ajaxPrefilter(function (s, origOptions) {
    ...
    if (typeof s.data !== "string" && !jQuery.isPlainObject(s.data) && !Array.isArray(s.data) &&
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/jquery-4.0.0-beta.js"], null)
//# sourceMappingURL=/jquery-4.0.0-beta.1e675a14.js.map